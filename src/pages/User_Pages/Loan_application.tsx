    ...
    <div className="flex h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden lg:ml-0">
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center">
              <button
                ...
                className="lg:hidden mr-4 p-2 rounded-xl bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 transition-all duration-200 shadow-lg"
              >
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="relative p-2 rounded-xl bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 transition-all duration-200 group shadow-lg">
                <Bell className="w-5 h-5 text-white" />
                <div className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-green-600 to-green-700 rounded-full flex items-center justify-center border-2 border-white">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          {/* Tab Navigation */}
          <div className="mb-8">
            <div className="flex space-x-1 bg-white/70 backdrop-blur-sm p-2 rounded-2xl border border-green-200/30 shadow-lg">
              {tabs.map((tab) => {
                  ...
                  <button
                    ...
                    className={`flex items-center space-x-2 px-6 py-3 rounded-xl font-semibold transition-all duration-200 ${
                      activeTab === tab.id
                        ...
                        : "text-black hover:bg-gradient-to-r hover:from-green-100 hover:to-green-200 hover:text-green-700"
                    }`}
                  >
